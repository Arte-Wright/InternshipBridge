...
if (isset($_POST['submit'])) {
  ...
  $link = mysqli_connect("localhost", "root", "132245", "sys") or die($link);
...
/*
	...
	{
		$funame = $_POST['funame'];
		$conn=mysqli_connect("localhost","root","132245","sys") or die("connection failed".mysqli_connect_error());
				...
				if($funame!=$uname)
				{
					echo "<script>alert('Username Does Not Exist');</script>";
								...
								{	
											...
											$mail->IsSMTP();
											$mail->SMTPDebug=0;
											$mail->From = "thapar.edu";
											$mail->FromName = "Thapar";
											$mail->Host="smtp.gmail.com";
											$mail->SMTPSecure='ssl';
											$mail->Port=465;
											$mail->SMTPAuth=true;

											$mail->Username='Thapar';
