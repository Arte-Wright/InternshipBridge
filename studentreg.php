...
if(isset($_POST['submit']))
{
    ...
    $conn = mysqli_connect("localhost","root","132245","sys") or die("failed to connect database");
...
$result = mysqli_query($conn, "INSERT INTO student (sname, mobile, 10th_marks, 12th_marks, grad_marks, gender, m_status, partner_name, username, pass) 
                               VALUES ('$sname', '$mob', '$ten', '$tentwo', '$grad', '$gender', '$m_status', '$pname', '$uname', '$pd')")
